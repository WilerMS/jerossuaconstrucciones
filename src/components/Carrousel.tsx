...
const Carousel: FC<CarouselProps> = ({ images }) => {
  ...
  return (
    <div className={`relative carousel flex flex-col items-center justify-center w-full h-full transition-transform duration-500`}>
      ...
      <button onClick={goToPrevious} className="prev-button absolute left-0 text-white opacity-70 hover:opacity-100 hover:scale-90 transition-all">
      ...
      <button onClick={goToNext} className="next-button absolute right-0 text-white opacity-70 hover:opacity-100 hover:scale-90 transition-all">
        <svg width="70" height="70" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
